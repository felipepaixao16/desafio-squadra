...
class __TwigTemplate_88852415c3f3282f5eae47824a00fa52 extends Template
{
...
($context["view_mode"] ?? null)) ? (("media--view-mode-" . \Drupal\Component\Utility\Html::getClass(($context["view_mode"] ?? null)))) : (""))];
  ...
  ";
        // line 24
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["title_suffix"] ?? null), "contextual_links", [], "any", false, false, true, 24), "html", null, true);
        yield "
  ";
        // line 25
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/classy/content/media.html.twig", "/var/www/html/web/core/themes/claro/templates/classy/content/media.html.twig");
    }
